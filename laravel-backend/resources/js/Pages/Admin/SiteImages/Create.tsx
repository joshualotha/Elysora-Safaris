...
export default function Create() {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.site-images.store'));
    };
        ...
        <AdminLayout>
            ...
            <div className="max-w-4xl mx-auto">
                <div className="mb-6">
                    ...
                    <h1 className="text-3xl font-bold tracking-tight text-charcoal mt-2">Add New Site Image</h1>
                </div>
                        ...
                        <div className="md:col-span-2 space-y-6">
                            <Card>
                                <CardContent className="p-6 space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="key">Unique Key * <span className="text-xs font-normal text-muted-foreground">(e.g., about_hero, services_cultural_intro)</span></Label>
                                        <Input
                                            id="key"
                                            value={data.key}
                            ...
                            <div className="flex justify-end gap-4">
                                ...
                                <Button type="submit" className="bg-sahara-gold hover:bg-sahara-gold/90 text-white" disabled={processing}>
                                    {processing ? 'Saving...' : 'Create Image'}
                                </Button>
                            </div>
                        </div>
                    </div>
