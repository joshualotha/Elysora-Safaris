...
export default function Edit({ slide }: EditProps) {
    ...
    const [preview, setPreview] = useState<string | null>(slide.image_path ? `/storage/${slide.image_path}` : null);
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.carousel-slides.update', slide.id));
    };
        ...
        <AdminLayout>
            ...
            <div className="max-w-4xl mx-auto">
                <div className="mb-6">
                    ...
                    <h1 className="text-3xl font-bold tracking-tight text-charcoal mt-2">Edit Carousel Slide</h1>
                </div>
