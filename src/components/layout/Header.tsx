                ...
                <NavigationMenuContent>
                  <div className="grid w-[600px] grid-cols-2 gap-4 p-4">
                    <div className="flex flex-col justify-center rounded-lg bg-sand p-6">
                         <Image src="https://images.unsplash.com/photo-1519974749222-634241604d59?q=80&w=2070&auto=format&fit=crop" alt="Planning" width={400} height={400} className="rounded-lg object-cover mb-4 aspect-video" />
